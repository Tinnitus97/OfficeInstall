...
<#
======================================================================
 Build-Skript fuer OfficeInstall (Avalonia / .NET 10)
----------------------------------------------------------------------
 ...
 Ergebnis liegt danach unter:  .\publish\OfficeInstall.exe
======================================================================
#>
[CmdletBinding()]
param(
...
# ---------------------------------------------------------------------
# 3. Paketquellen pruefen (Ursache von NU1100 = keine nuget.org-Quelle)
# ---------------------------------------------------------------------
...
# ---------------------------------------------------------------------
# 6b. Aufraeumen: native Debug-Symbole (.pdb) entfernen
# ---------------------------------------------------------------------
...
Write-Host "Die EXE gehoert in denselben Ordner, in dem frueher die start.bat lag (neben x32 und x64)." -ForegroundColor DarkGray
